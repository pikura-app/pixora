...
namespace Pikura.Agent;

/// <summary>
/// Lightweight named-pipe server. Accepts connections from the main Pikura UI
/// and broadcasts JSON-line progress messages to all connected clients.
/// Pipe name: "pikura-agent" on Windows, "/tmp/pikura-agent" socket on Unix.
/// </summary>
public sealed class IpcServer : IAsyncDisposable
{
    public const string PipeName = "pikura-agent";
