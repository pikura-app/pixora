...
/// Broadcasts progress events over the named pipe so the Pikura UI can display them.
/// </summary>
public sealed class AgentWorker : BackgroundService
{
    ...
    {
        _logger.LogInformation("Pikura Agent starting");
        ...
        _logger.LogInformation("Pikura Agent stopped");
    }
