...
public class NavigationService
{
    ...
    private Type GetViewType<T>() where T : ViewModelBase
    {
        ...
        if (viewType == null)
        {
            ...
            viewType = typeof(App).Assembly.GetType($"Pikura.Avalonia.Views.{viewTypeName}");
        }
        ...
        if (viewType == null)
        {
            ...
            {
                $"Pikura.Avalonia.Views.{viewTypeName}",
                $"Pikura.Avalonia.Views.Gallery.{viewTypeName}",
                $"Pikura.Avalonia.Views.Settings.{viewTypeName}",
                $"Pikura.Avalonia.Views.Rankings.{viewTypeName}",
                $"Pikura.Avalonia.Views.Artwork.{viewTypeName}"
            };
